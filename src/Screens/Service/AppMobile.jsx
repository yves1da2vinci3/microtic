...
import WebImage from '../../assets/Images/webImage.jpg'
import WebImage2 from '../../assets/Images/SecondWebImage.jpg'
...
import appImage from '../../assets/Icon/mobile.jpg'
import notification from '../../assets/Icon/notification.png'
import idea from '../../assets/Icon/idea-bulb.png'
import analytic from '../../assets/Icon/analytic.png'
function AppMobile() {
  ...
  <h1 className='text-left text-[#233653]  text-3xl font-bold mt-4' >Créez une application mobile au service de votre performance</h1>
<p className='text-gray-400 text-lg' >Vous aurez une solution de conception d'applications mobiles sous Android et IOS, Tablettes et Smartphones, afin d'obtenir le maximum d'impact possible en termes d'utilisateurs et de déploiement de l'application. Nous gérons le déploiement et la mise à jour sur les stores des nouvelles versions.</p>


        </div>
        <div className='flex items-center justify-center'>
            <img src={appImage} className="h-[30rem] w-[30rem] " />
        </div>
      </div>
      {/* Comment on procede */}
...
<ul className='flex flex-col mt-8 ml-2 md:ml-8  list-none' >
    ...
    <li className='flex flex-row md:translate-x-36 items-center mb-8'>
        ...
        <div className='flex w-[35rem] h-full items-center justify-center'>
            <img src={WebImage2} className="md:h-[30rem] h-[25rem] w-[25rem] md:w-[30rem]" />
        </div>
      </div>
      ...
      <div className=' h-[9rem]  md:h-[8rem] flex-wrap px-6 justify-center md:justify-between  bg-[#233653] w-full flex items-center '>
        ...
        VOUS AVEZ UN PROJET ? Demandez votre devis gratuit en quelques clics
        </p>
...
<div className='h-[30rem] cursor-pointer w-[23rem] gap-y-4 group  drop-shadow-lg  hover:dropdown-xl hover:rounded-xl hover:shadow-lg p-3 flex flex-col'>
<img className='h-24 w-24 self-center' src={notification} />

<h1 className='text-center text-xl font-semibold mt-5  '>
Notification et push</h1>
<p className='text-gray-500 text-center  '>
Que ce soit pour publier l’actualité de votre entreprise ou annoncer vos promotions, vous allez avoir la possibilité de vous exprimer sans limites et en temps réel.
.</p>
</div>
...
<img className='h-24 w-24 self-center' src={analytic} />

<h1 className='text-center text-xl font-semibold mt-5  '>
Ergonomie</h1>
<p className='text-gray-500 text-center  '>
Afin que l’interface de votre application corresponde à vos attentes et à vos besoins, la conception de votre application mobile respectera la cohérence visuelle nécessaire, qui se résume au design, à l’ergonomie et à la facilité d’utilisation.</p>
</div>
