...
import identity from '../../assets/Icon/Identity.jpg'
...
function Identity() {
  ...
  <h1 className='text-left text-[#233653]  text-3xl font-bold mt-4' >Confiez-nous la création de votre identité visuelle</h1>
<p className='text-gray-400 text-lg' >Vous recherchez une agence de création graphique pour votre communication visuelle ? La création d’un logo pour votre entreprise ? Ou renforcer votre image ? Nous sommes prêts à relever le défi !

C’est pourquoi, notre agence de communication digitale s’attache à vous produire les meilleurs supports de communication afin de développer votre activité à travers votre identité.</p>


        </div>
        <div className='flex items-center justify-center'>
            <img src={identity} className="h-[30rem] w-[30rem] " />
        </div>
      </div>
      {/* Comment on procede */}
...
<ul className='flex flex-col mt-8 ml-2 md:ml-8  list-none' >
    ...
    <li className='flex  md:translate-x-36 flex-row items-center mb-8'>
        ...
        <p className='text-gray-400  text-md md:text-lg mt-5 ml-3' >Une collaboration étroite entre MediaZain et nos clients pour échanger sur les différentes directions et de compléter les visions et les idées.</p>
    ...
    <li className='flex  flex-row items-center mb-8'>
        ...
        <p className='text-gray-400  text-md md:text-lg mt-5 ml-3' >Plusieurs logos vous seront proposés. Vous pourrez donc choisir celui qui vous représente le mieux.</p>
    ...
    <li className='flex flex-row  items-center mb-8'>
        ...
        <div className='flex flex-col flex-1'>
        <p className='text-[#233653] font-semibold  text-md md:text-lg ml-3' >Différentes déclinaisons</p>
        <p className='text-gray-400  text-md md:text-lg mt-5 ml-3' >Nous réalisons pour vous plusieurs supports, tels que les cartes visites et papiers en-tête, brochures ou plaquettes.</p>
    ...
    <li className='flex flex-row md:translate-x-36 items-center mb-8'>
        ...
        <div className='flex w-[35rem] h-full items-center justify-center'>
            <img src={identity2} className="md:h-[26rem] h-[25rem] w-[25rem] md:w-[26rem]" />
        </div>
      </div>
